...
class script(object):
    HOME_BUTTONURL_UPDATES = environ.get("HOME_BUTTONURL_UPDATES", 'https://du-link.in/ref/Mfomovie')
    START_TXT = environ.get("START_TXT", '''<b>Hello {} 👋🏻 I'm an CA_Movie Auto Filter Bot (Movie Search Bot) Maintained by @CA_Movie. We are Providing Tamil and Tamil Dubbed Movies. More Languages Coming Soon. I Can Support Upto 4GB File. You Can Get added Files GDrive Links and 4GB above Links also. Keep me Join to Our Official Channel to Receive Bot & Movies Updates in @UK_Studios_Official. Check "😁 About" Button.</b>''')
    HELP_TXT = """<b>Hi {}
I have that Features.</b>"""
    ABOUT_TXT = """<b><i>🤖 My Name : <a href=https://t.me/Kratos_Filter_Bot><b>Kratos Filter Bot</b></a>\n
🧑🏻‍💻 Developer : <a href=https://t.me/Butcherbi><b>Butcherbi</b></a>\n
📝 Language : Pyrogram\n
📚 Framework : Python3\n
📡 Hosted on : VPS\n
